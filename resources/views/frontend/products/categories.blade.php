...
<div class="inner_sec packaging_solutions" style="background: #3e4e67 url('{{ $bannerImage }}') center top no-repeat; background-size: cover;">
    <div class="container">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="procat_nms">
                                      ...
                                      <div class="blue_btn">
    <a href="{{ url('/products/' . $category->seourl . '/solid-dosages/' . $subcat->seourl) }}">
