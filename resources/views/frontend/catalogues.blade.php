                                    ...
                                    >
                                        ...
                                        >
                                            <div class="elementor-widget-container">
                                                ...
                                                <h2 class="sub-heading alt"><span class="mini-heading">Our Brochure</span> <span class="heading"> Explore Our Collections</span></h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container">
                                    <div class="heading-box">
                                        ...
                                        >
                                            ...
                                            >
                                                <div class="elementor-widget-container">
                                                    <h4 class="wcf--title">Brochure Collection</h4>
                                                    <h2 class="wcf--title alt">Our Brochure</h2>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="catalogues-wrapper">
                                                <div class="catalogues-card">
                                                    <div class="image-action">
                                                        <div class="image-box">
                                                            <img src="./img/document-thumbnails/catalogues/shera-pro.jpg" alt="" />
                                                        </div>
                                                        <div class="action-button">
                                                            <a class="button download-button" href="./pdf/catelogues/Shera_Pro_Product_Brochure.pdf#toolbar=0&navpanes=0&scrollbar=0" data-fancybox>
                                                                View
                                                            </a>
                                                            <a href="#" class="button download-button" data-bs-toggle="modal" data-bs-target="#viewDownloadModal" data-pdf="Shera_Pro_Product_Brochure.pdf" data-source="catalogues"> Download </a>
                                                        </div>
                                                    </div>
                                                    <div class="title-box mt-3">
                                                        <h5 class="shera-mini-heading">
                                                            <span class="shera-green">SHERA</span>
                                                            <span class="shera-brown">Pro </span>Product Brochure
                                                        </h5>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-3 mt-4">
                                            <div class="catalogues-wrapper">
                                                <div class="catalogues-card">
                                                    <div class="image-action">
                                                        <div class="image-box">
                                                            <img src="./img/document-thumbnails/catalogues/shera-neu.jpg" alt="" />
                                                        </div>
                                                        <div class="action-button">
                                                            <a class="button download-button" href="./pdf/catelogues/Shera_Neu_Brochure.pdf#toolbar=0&navpanes=0&scrollbar=0" data-fancybox> View </a>
                                                            <a href="#" class="button download-button" data-bs-toggle="modal" data-bs-target="#viewDownloadModal" data-pdf="Shera_Neu_Brochure.pdf" data-source="catalogues"> Download </a>
                                                        </div>
                                                    </div>
                                                    <div class="title-box mt-3">
                                                        <h5 class="shera-mini-heading">
                                                            <span class="shera-green">SHERA</span>
                                                            <span class="shera-blue">Neu </span>Brochure
                                                        </h5>
                                                    </div>
                                                </div>
                                            </div>
            ...
            Fancybox.bind("[data-fancybox]", {
                on: {
                    reveal: (fancybox, slide) => {
                        // If it's a PDF, append toolbar=0 to hide PDF viewer toolbar
                        if (slide.src.endsWith(".pdf")) {
                            slide.$iframe.src = slide.src + "#toolbar=0";
                        }
                    },
                },
            });
