   ...
   @include('frontend.layout.header')
                    ...
                    <div data-elementor-type="wp-page" data-elementor-id="34" class="elementor elementor-34">
                        <div class="inner-page shera-project-page">
                                    ...
                                    >
                                        ...
                                        >
                                            <div class="elementor-widget-container">
                                                ...
                                                <h2 class="sub-heading alt"><span class="mini-heading">Project</span> <span class="heading">{{ $project->title }}</span></h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container">
                                    <div class="heading-box">
                                        ...
                                        >
                                            ...
                                            >
                                                <div class="elementor-widget-container">
                                                    <h4 class="wcf--title">Commercial Building</h4>
                                                    <h2 class="wcf--title alt">{{ $project->title }}</h2>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="text-content">
                                                ...
                                                <ul class="detail-list mb-5">
                                                    <li class="list-item"><span>Location : </span> {{ $project->city_state_name }}</li>
                                                    <li class="list-item"><span>Product : </span>{{ $project->products }}</li>
                                                    <li class="list-item"><span>Thickness : </span> {{ $project->thickness }}</li>
                                                    <li class="list-item"><span>Size : </span> {{ $project->size }}</li>
                                                    <li class="list-item"><span>Total Sq.Ft. : </span> {{ $project->total_sqft }}</li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="swiper-container">
                                                <div class="swiper project-image-swipper">
                                                    ...
                                                    <div class="swiper-wrapper">
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="image-box">
                                                                <img src="{{ asset($img->urls) }}" class="carousel-image" alt="{{ $img->alt }}" data-fancybox="project-image" />
                                                                <div class="hover-box">
                                                                    <img src="{{ asset('img/icons/view-gallery.png') }}" alt="" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                       @endforeach
                                            ...
                                            <div class="image-tagline text-center">
                                                <i>{{ $project->title }} - {{ $project->city_state_name }}</i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <section class="section projects-section alt background-section">
                                <div class="container">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="swiper-container">
                                                    <div class="swiper project-swipper">
                                                        ...
                                                        <div class="swiper-wrapper">
                                                            <!-- Slides -->
                                                            @foreach ($relatedProjects as $projects)
                                                            <div class="swiper-slide">
                                                                <a href="{{ route('frontend.project.details', $projects->url) }}" class="product-card">
                                                                    <div class="image-box">
                                                                        <img src="{{ asset($projects->banner_image) }}" alt="{{ $projects->title }}" />
                                                                        <div class="hover-box">
                                                                            <div class="icon-box">View</div>
                                                                            <div class="text-box">
                                                                                <ul class="detail-list">
                                                                                    <li class="list-item">
                                                                                        <p class="date"><span>Location : </span>{{ $projects->city_state_name }}</p>
                                                                                    </li>
                                                                                    <li class="list-item">
                                                                                        <p class="date"><span>Total Sq.Ft. : </span>{{ $projects->total_sqft }}</p>
                                                                                    </li>
                                                                                    <li class="list-item">
                                                                                        <p class="date"><span>Product : </span> {{ $projects->products }}</p>
                                                                                    </li>
                                                                                    <li class="list-item">
                                                                                    <p class="date"><span>Thickness : </span> {{ $projects->thickness }}</p>
                                                                                    </li>
                                                                                    <li class="list-item">
                                                                                        <p class="date"><span>Size : </span> {{ $projects->size }}</p>
                                                                                    </li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
        ...
        <script>
            ...
            jQuery(document).ready(function ($) {
                ...
                new Swiper(".project-image-swipper", {
                    loop: false,
                    autoplay: {
                        delay: 3000,
                        disableOnInteraction: false,
