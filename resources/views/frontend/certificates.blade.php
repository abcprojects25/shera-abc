                                ...
                                <div class="container">
                                    <div class="heading-box">
                                        ...
                                        >
                                            ...
                                            >
                                                <div class="elementor-widget-container">
                                                    <h4 class="wcf--title">Commitment to Standards</h4>
                                                    <h2 class="wcf--title alt">Our Certifications</h2>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="catalogues-wrapper">
                                                <div class="catalogues-card">
                                                    <div class="image-action">
                                                        <div class="image-box">
                                                            <img src="./img/document-thumbnails/certificates/certificates.jpg" alt="" />
                                                        </div>
                                                        <div class="action-button">
                                                            <a
                                                                class="button download-button"
                                                                href="./pdf/certification/Green_Certification_Green_Choice_Philippines.pdf#toolbar=0&navpanes=0&scrollbar=0"
                                                                data-fancybox
                                                            >
                                                                View
                                                            </a>
                                                    ...
                                                    <div class="title-box mt-3">
                                                        <h5 class="shera-mini-heading">Green certification - Green Choice Philippines</h5>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
