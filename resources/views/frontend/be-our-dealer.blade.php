...
<html class="no-js" lang="en">
  ...
  @include('frontend.layout.header')
                    ...
                    >
                      <div class="elementor-widget-container">
                        ...
                        <h2 class="sub-heading alt">
                          <span class="mini-heading">Be Our Dealer</span>
                          <span class="heading"
                            >Let’s Build Profitable Partnerships – Join Us</span
                          >
                        </h2>
                      </div>
                    </div>
          ...
          <section class="container contact_form">
            <div
              class="row contact_form_1 align-items-center justify-content-center"
            >
              <div class="col-md-6 contact_form_heading mb-4">
                <p class="mb-0">Build Beyond <span>Limits</span></p>
                <p class="contact_form_para">
                  Become a part of our <span>growing</span> family and take your
                  <span>business</span> to the next level with our strong brand
                  backing.
                </p>
              </div>
            </div>
            ...
            <div class="contact_form_2 row mt-4">
              <div class="col-md-6 mb-4 contact_form_right">
                <!-- <p>Reach out to us</p> -->
                <span class="badge text-bg-light">Become Our Dealer !</span>
                <!-- <h2 class="contact-heading">We would love to hear from you!</h2> -->
                <!-- <p>
                  Become a part of our growing family and take your business to
                  the next level with our strong brand backing.
                </p> -->
                <div class="row d-flex mt-4 mb-4">
                  <div class="col-md-6">
                    <div class="contact-item-card">
                      ...
                      <a href="mailto:india_sales@shera.com"
                        ><i class="fas fa-envelope-open"></i>
                        <span style="margin-left: 10px">
                          india_sales@shera.com</span
                        >
                      </a>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="contact-item-card">
                      <h4>
                        <span><i class="fas fa-id-badge"></i></span> Calls us
                        directly
                      </h4>
                      <p>Available during working hours</p>
                      <a href="tel:+918097499099"
                        ><i class="fas fa-phone-alt"></i>
                        <span style="margin-left: 10px">+918097499099</span></a
                      >
                    </div>
                  </div>
                </div>
                ...
                <div class="d-flex align-items-center">
                  <div class="col-md-6">
                    <h2>or you can connect with us!</h2>
                  </div>
                  <div
                    class="elementor-element elementor-element-845e997 elementor-widget elementor-widget-wcf--arolax-button col-md-6 mt-2"
                    data-id="845e997"
                    data-element_type="widget"
                    ...
                    <div class="elementor-widget-container">
                      <div class="wc-btn-wrapper style-2">
                        <a href="{{ url('contact-us') }}" class="wc-btn-group">
                          ...
                          <span class="wc-btn-primary"> Contact Us</span>
                          <span class="wc-btn-play">
                            <i
                              aria-hidden="true"
                              class="arolax-theme arolax-wcf-icon icon-wcf-arrow-up-right2"
                ...
                <div class="company_map">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d10662.791809144925!2d72.8716079605197!3d19.113524951987493!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c812c3a255db%3A0x533ad511b0a8e98f!2sWeWork%20Raheja%20Platinum%20-%20Coworking%20%26%20Office%20Space%20in%20Andheri%20East%2C%20Mumbai!5e0!3m2!1sen!2sin!4v1754907776912!5m2!1sen!2sin"
                    width="600"
                    height="300"
                    style="border: 0"
                    allowfullscreen=""
  ...
  @csrf
  <input type="hidden" name="source" value="dealer">
...
document.getElementById('dealerForm').addEventListener('submit', function(e) {
    ...
    <script type="text/javascript" defer src="/js/map.js" defer></script>
    <script
      async
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCDrZXVRfCyhLoRj5WrsSFseK1xPxYC4wA&loading=async&callback=initMap"
    ></script>
    <script>
      let map;
      const locations = {
