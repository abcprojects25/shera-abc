...
<html class="no-js" lang="en">
   ...
   @include('frontend.layout.header')
                                        ...
                                        >
                                            <div class="elementor-widget-container">
                                                ...
                                                <h2 class="sub-heading alt">
                                                    ...
                                                    <span class="heading">Join Us in Building a Better Tomorrow</span>
                                                </h2>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div data-elementor-type="wp-page" data-elementor-id="6543" class="elementor elementor-6543 home_about">
                        <div
                            class="elementor-element elementor-element-be7fb25 e-flex e-con-boxed e-con e-parent e-lazyloaded"
                            data-id="be7fb25"
                            data-element_type="container"
                            data-settings='{"wcf_enable_cursor_hover_effect_text":"View","wcf-animation":"none"}'
                        >
                            <div class="e-con-inner" style="padding: 0 !important">
                                        ...
                                        <div class="">
                                            <div class="job__detail-wrapper">
                                                ...
                                                <div class="job__detail-content">
                                                    ...
                                                    <p>
                                                        We’re committed to creating the happiest company working for and is proud to provide equal opportunity to all. All the qualified applicants will
                                                        receive consideration for employment without regard to race, color, ancestry, religion.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="pin-spacer">
                                                        <div class="job__detail-sidebar">
                                                            ...
                                                            <div
                                                                ...
                                                                style="transition: none; translate: none; rotate: none; scale: none; transform: translate(0px, 0px); opacity: 1; margin-top: 20px"
                                                            >
                                                                <div class="elementor-widget-container">
                                                                    <div class="wc-btn-wrapper style-2">
                                                                        <a href="{{ url('apply-job')}}" class="wc-btn-group">
                                                                            ...
                                                                            <span class="wc-btn-primary"> Apply for job </span>
                                                                            <span class="wc-btn-play">
                                                                                <i aria-hidden="true" class="arolax-theme arolax-wcf-icon icon-wcf-arrow-up-right2"></i>
                                                                            </span>
                                                                        </a>
        ...
        </div>  @include('frontend.layout.enquiryModal')
