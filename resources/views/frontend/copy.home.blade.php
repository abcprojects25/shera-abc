					...
					<form method="post" action="/contacts" id="inquiry" enctype="multipart/form-data">
						...
						<div class="form-group">
							<input type="text" id="name" name="name"
								...
								placeholder="Search Products...." required="required">
							@error('name')
		...
		<div class="swiper-wrapper">
			<div class="swiper-slide slide_1">
				<div class="slide_captions">
					...
					<p> From design to delivery, we provide seamless and efficient packaging solutions tailored to your
						needs. </p>
					<a href="#" class="btn"> View Packaging Products <img src="/img/icon/link.svg"
							class="img-fluid" /></a>
				</div> <!-- -->
			...
			<div class="swiper-slide slide_2">
				<div class="slide_captions">
					...
					<a href="#" class="btn"> View Raw Material Products <img src="/img/icon/link.svg"
							class="img-fluid" /></a>
				</div> <!-- -->
			...
			<div class="swiper-slide slide_3">
				<div class="slide_captions">
					...
					<a href="#" class="btn"> View Manufacturing Products <img src="/img/icon/link.svg"
							class="img-fluid" /></a>
				</div> <!-- -->
...
<div class="swiper-container" id="serviceSlide">
	<div class="swiper-wrapper service-carousel">
		<div class="swiper-slide"> <a href="#" class="slide_1"> <span> Pharma </span> <img src="/img/icon/link_1.svg"
					class="img-fluid" /> </a> </div>
		<div class="swiper-slide"> <a href="#" class="slide_2"> <span> Nutraceutical </span> <img
					src="/img/icon/link_1.svg" class="img-fluid" /> </a> </div>
		<div class="swiper-slide"> <a href="#" class="slide_3"> <span> Alcohol </span> <img src="/img/icon/link_1.svg"
					class="img-fluid" /> </a> </div>
		<!-- <div class="swiper-slide"> <a href="#" class="slide_4"> <span> Cosmetics </span> <img src="/img/icon/link_1.svg" class="img-fluid" /> </a> </div> 
			<div class="swiper-slide"> <a href="#" class="slide_5"> <span> FMCG </span> <img src="/img/icon/link_1.svg" class="img-fluid" /> </a> </div>  -->
		...
		<div class="row">
			<div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-duration="800">
				<div>
					...
					<br />
					<a href="#" class="know_more blue_btn"> Know More <span> <img src="/img/icon/link_1.svg"
		...
		<div class="row justify-content-md-between home_product_list">
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="relative">
					...
					<div class="img-cover"> <img src="/img/packaging_solutions.jpg" class="img-fluid" /> </div>

					<div class="box">
						<h4> Packaging <br /> Solutions </h4>
						<p> Unlike other suppliers, we are not limited by type, material or origin. We provide seamless,
							end-to-end packaging solutions, so you won’t need to look anywhere else. </p>

						<div class="hover_cont">
							<ul>
								<li> <a href="#"> <i class="fa-solid fa-arrow-right prev_arw"></i> Pharmaceutical <i
											class="fa-solid fa-arrow-right nxt_arw"></i> </a> </li>
								<li> <a href="#"> <i class="fa-solid fa-arrow-right prev_arw"></i> Alcohol <i
											class="fa-solid fa-arrow-right nxt_arw"></i> </a> </li>
								<li> <a href="#"> <i class="fa-solid fa-arrow-right prev_arw"></i> F&B <i
											class="fa-solid fa-arrow-right nxt_arw"></i> </a> </li>
							</ul>
						</div>
					</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="relative">
					<img src="/img/shape_2.png" class="img-fluid shape" />
					<div class="img-cover"> <img src="/img/rawmaterial_solutions.jpg" class="img-fluid" /> </div>
					<div class="box">
						<h4> Raw Material <br /> Solutions </h4>
						<p> Our end-to-end solutions include sourcing raw materials, consolidating shipments, and
							ensuring quality and onsistency throughout the supply chain. </p>

						<div class="hover_cont">
							<a href="#" class="vewprdt"> View Products <svg width="11" height="10" viewBox="0 0 11 10"
		...
		<div class="row  align-items-end">
			<div class="col-md-6 suntainability_img">
				<div data-aos="fade-right" data-aos-duration="800">
					<img src="/img/suntainability.png" class="img-fluid" />
				</div>
			</div>
			<div class="col-md-6">
				<div class="banner_title" data-aos="fade-up" data-aos-duration="800">
					<img src="/img/icon/star.svg" class="img-fluid star" />
					<h1 class="bebas main_heading"> Suntainability </h1>
				...
				<a href="#" class="know_more blue_btn"> Choose Sustainability <span> <img src="/img/icon/link_1.svg"
							class="img-fluid" /> </span> </a>
...
<section id="blogs" class="">
	<div class="container">
		...
		<div class="row justify-content-md-between homeBlog_list">
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="relative">
					<div class="img-cover"> <img src="/img/blog/blog_1.jpg" class="img-fluid" /> </div>
					<div class="box">
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="relative">
					<div class="img-cover"> <img src="/img/blog/blog_2.jpg" class="img-fluid" /> </div>
					<div class="box">
						<p class="date mb-0"> 17 Jul, 2024 </p>
						<h5> Lorem ipsum dolor sit amet consectetur. </h5>
						<p> Lorem ipsum dolor sit amet consectetur. Lorem ipsum dolor sit amet consectetur. Lorem ipsum
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="relative">
					<div class="img-cover"> <img src="/img/blog/blog_3.jpg" class="img-fluid" /> </div>
					<div class="box">
						<p class="date mb-0"> 17 Jul, 2024 </p>
						<h5> Lorem ipsum dolor sit amet consectetur. </h5>
						<p> Lorem ipsum dolor sit amet consectetur. Lorem ipsum dolor sit amet consectetur. Lorem ipsum
