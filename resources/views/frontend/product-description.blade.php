                ...
                <div id="page" class="hfeed site">
                    ...
                    <div data-elementor-type="wp-page" data-elementor-id="34" class="elementor elementor-34">
                        <div class="inner-page product-page product-description-page">
                                    ...
                                    >
                                        ...
                                        >
                                            <div class="elementor-widget-container">
                                                ...
                                                <h2 class="sub-heading alt"><span class="mini-heading">Product</span> <span class="heading">The Product Of Luxury</span></h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                                ...
                                                                >
                                                                    <div class="product-card alt">
                                                                        <div class="text-content">
                                                                            ...
                                                                            <ul class="product-description-list mb-6">
                                                                                <li class="list mb-4">
                            ...
                            <section class="section more-products-section background-section">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-12 col-lg-5">
                                            <div class="heading-box mb-5">
                                                ...
                                                <!-- <p class="mb-4">More deco board textures</p> -->
                                                <div
                                        ...
                                        <div class="col-12 col-lg-7">
                                            <div class="products-container">
                                                <div class="products-listing">
                                                    <div class="swiper-container">
                                                        <div class="swiper products-swipper">
                                                            <!-- Additional required wrapper -->
                                                            <div class="swiper-wrapper">
                                                                <!-- Slides -->
                                                                <div class="swiper-slide">
