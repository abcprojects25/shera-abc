...
<html class="no-js" lang="en">
  ...
  @include('frontend.layout.header')
                    ...
                    >
                      <div class="elementor-widget-container">
                        ...
                        <h2 class="sub-heading alt">
                          ...
                          <span class="heading"
                            >let’s us know how we can help!</span
                          >
                        </h2>
                      </div>
                    </div>
          ...
          <section class="container career_container">
            <div class="career_main">
              ...
              <div class="career_bottom_sec career_heading">
                <p class="line-height">With Shera</p>
              </div>
            </div>
            <div class="contact_page_img_container">
          ...
          <section class="container contact_form">
            <div class="contact_form_2 row align-items-center g-6 mt-4">
              <div class="col-md-6 mb-4 contact-img-banner-l">
                <img src="./img/solutions-2.jpg" alt="" />
              </div>
              ...
              <div class="col-md-6 contact_form_right">
                <div class="col-md-12 mb-4">
                  <!-- <p>Reach out to us</p> -->
                  <span class="badge text-bg-light">Reach out to us!</span>
                  <h2 class="contact-heading">
                    We would love to hear from you!
                  </h2>

                  <p class="contact-paragraph">
                    Your thoughts matter to us. Share your questions, ideas, or
                    feedback, and our team will be in touch soon. We’re just a
                    message away. or reach our manually at
                    <a href="mailto:india_sales@shera.com"
                      >india_sales@shera.com</a
                    >
                  </p>
                </div>
...
document.getElementById('enquiryForm').addEventListener('submit', function(e) {
    ...
    btnText.innerHTML = '<i class="fas fa-spinner fa-spin"></i> Sending...';
          ...
          <section class="container">
            <div class="row">
              <div class="col-md-12 mb-4">
                <p class="contact-info-b-details">
                  Would you like to be our dealer?
                </p>
              </div>
              <div class="col-md-8">
                <p class="contact-dealer-info">
                  Join hands with us to unlock new opportunities. Become a
                  valued dealer today or connect with us as an existing partner
                  — together, we grow stronger
                </p>
              </div>
              <div class="row">
                <div class="col-md-2">
                  <span class="badge text-bg-light">Became our Dealer</span>
                </div>
                <div class="col-md-3">
                  <span class="badge text-bg-light">Our Current Dealer</span>
                </div>
              </div>
            </div>
            <div class="row mt-4 mb-4">
              ...
              <div class="col-md-4">
                <div class="contact-item-card">
                  <span><i class="fad fa-building"></i></span>
                  <h4>Visit our Office</h4>
                  <p>Check our location in real life.</p>
                  <a href=""
                    ><i class="fas fa-street-view"></i>
                    <span style="margin-left: 10px"
                      >Mahaphant India Private Limited</span
                    ></a
                  >
                </div>
              </div>
