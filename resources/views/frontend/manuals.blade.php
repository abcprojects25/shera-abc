                                    ...
                                    >
                                        ...
                                        >
                                            <div class="elementor-widget-container">
                                                ...
                                                <h2 class="sub-heading alt"><span class="mini-heading">User Manuals </span> <span class="heading"> Find all manuals in one place</span></h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container">
                                    <div class="heading-box">
                                        ...
                                        >
                                            ...
                                            >
                                                <div class="elementor-widget-container">
                                                    <h4 class="wcf--title">Need Help Using Our Products?</h4>
                                                    <h2 class="wcf--title alt">User Manuals</h2>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="catalogues-wrapper">
                                                <div class="catalogues-card">
                                                    <div class="image-action">
                                                        <div class="image-box">
                                                            <img src="./img/document-thumbnails/manuals/Shera_Standard_Manual_Painting.jpg" alt="" />
                                                        </div>
                                                        <div class="action-button">
                                                            <a class="button download-button" href="./pdf/manual/Shera_Standard_Manual_Painting.pdf#toolbar=0&navpanes=0&scrollbar=0" data-fancybox>
                                                                View
                                                            </a>
                                                            <a href="#" class="button download-button" data-bs-toggle="modal" data-bs-target="#viewDownloadModal" data-pdf="Shera_Standard_Manual_Painting.pdf" data-source="manuals"> Download </a>
                                                        </div>
                                                    </div>
                                                    <div class="title-box mt-3">
                                                        <h5 class="shera-mini-heading">
                                                            <span class="shera-green">SHERA</span>
                                                            Standard Painting Manual
                                                        </h5>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-3 mt-4">
                                            <div class="catalogues-wrapper">
                                                <div class="catalogues-card">
                                                    <div class="image-action">
                                                        <div class="image-box">
                                                            <img src="./img/document-thumbnails/manuals/Standard_Manual_Jointing_Compound.jpg" alt="" />
                                                        </div>
                                                        <div class="action-button">
                                                            <a class="button download-button" href="./pdf/manual/Standard_Manual_Jointing_Compound.pdf#toolbar=0&navpanes=0&scrollbar=0" data-fancybox>
                                                                View
                                                            </a>
                                                            <a href="#" class="button download-button" data-bs-toggle="modal" data-bs-target="#viewDownloadModal" data-pdf="Standard_Manual_Jointing_Compound.pdf" data-source="manuals"> Download </a>
                                                        </div>
                                                    </div>
                                                    <div class="title-box mt-3">
                                                        <h5 class="shera-mini-heading">
                                                            <span class="shera-green">SHERA</span>
                                                            Standard Jointing Compound Manual
                                                        </h5>
                                                    </div>
                                                </div>
                                            </div>
