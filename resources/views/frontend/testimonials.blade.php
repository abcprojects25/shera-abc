   ...
   @include('frontend.layout.header')
                                    ...
                                    >
                                        ...
                                        >
                                            <div class="elementor-widget-container">
                                                ...
                                                <h2 class="sub-heading alt"><span class="mini-heading">Testimonials</span> <span class="heading">What Our Clients Say</span></h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="testimonials-wrapper">
                                        <div class="row">
                                            <div class="col-12 col-lg-12">
                                                <a href="./video/testimonial/Contractor_Abdul_Ansari.mp4" class="testimonials-card" data-fancybox data-caption="Caption 1">
                                                    <div class="content-box">
                                                        <div class="text-content">
                                                            <p class="shera-para testimonial-text mb-4">
                                                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure ducimus praesentium blanditiis reprehenderit suscipit delectus esse, et
                                                                enim quibusdam aliquid?
                                                            </p>
                                                            ...
                                                            <h3 class="heading mb-2">Mr. Arnav Seth</h3>
                                                            <h3 class="mini-heading">Associate Architect, Hafeez Contractor</h3>
                                                            <div class="icon-box">
                                                                <img src="./img/svg/quotes.svg" alt="" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="image-box">
                                                        ...
                                                        <div class="hover-box">
                                                            <img src="./video/testimonial/play.svg" alt="" />
                                                        </div>
                                                    </div>
                                                </a>
                                                <a href="./video/testimonial/Contractor_Abdul_Ansari.mp4" class="testimonials-card alt" data-fancybox data-caption="Caption 1">
                                                    <div class="image-box">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 mb-3">
                                            ...
                                            >
                                                <div class="elementor-widget-container">
                                                    ...
                                                    <h4>Contractor - Abdul Ansari Testimonial</h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6 mb-3">
                                            ...
                                            >
                                                <div class="elementor-widget-container">
                                                    ...
                                                    <h4>Contractor Kaleem Testimonial</h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6 mb-3">
                                            ...
                                            >
                                                <div class="elementor-widget-container">
                                                    ...
                                                    <h4>Shera Kerala Testimonial</h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6 mb-3">
                                            ...
                                            >
                                                <div class="elementor-widget-container">
                                                    ...
                                                    <h4>Shri Laxmi Timber Mart (Channel Partner - Mumbai) Testimonial</h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6 mb-3">
        ...
        <script>
            Fancybox.bind("[data-fancybox]", {
                ...
                // on: {
                //     ready: (fancyboxRef) => {
                //         document.querySelector(".fancybox__thumbs.f-thumbs").style.display = "none";
                //     },
                // },
            });
        </script>
