...
<html class="no-js" lang="en">
    ...
    @include('frontend.layout.header')
                    ...
                    <div data-elementor-type="wp-page" data-elementor-id="34" class="elementor elementor-34">
                        <div class="inner-page event-gallary-page">
                                    ...
                                    >
                                        ...
                                        >
                                            <div class="elementor-widget-container">
                                                ...
                                                <h2 class="sub-heading alt"><span class="mini-heading">Event Gallery</span> <span class="heading">Our Events in Pictures</span></h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container">
                                    <div class="heading-box mb-0">
                                        ...
                                        >
                                            ...
                                            >
                                                <div class="elementor-widget-container">
                                                    <h4 class="wcf--title">Moments That Matter</h4>
                                                    <h2 class="wcf--title alt">Events Gallery</h2>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <p class="shera-para mb-6">
                                        Browse through our curated collection of photos and videos from past events, capturing the energy, smiles, and special memories we’ve shared together. From
                                        vibrant celebrations to inspiring gatherings, relive the highlights here.
                                    </p>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-lg-3">
                                                <div class="nav-tabs" data-aos="fade-up" data-delay="0.5">
                                                    <div
                                                        class="elementor-element elementor-widget elementor-widget-accordion"
                                                        data-element_type="widget"
                                                            ...
                                                            <div class="accordion-container">
                                                                <div class="elementor-accordion" data-active="yes">
                                                                    <div class="elementor-accordion-item">
                                                                        ...
                                                                        <div
                                                                            id="elementor-tab-content-4131"
                                                                            class="elementor-tab-content elementor-clearfix"
                                                                            data-active="yes"
                                                                            data-indexkey="27760f6_0"
                                                                        >
                                                                            <div class="wcf--inner--accrodion--body">
                                                                                <div class="wcf--content">
                                                                                    <div class="tab active" data-target="product1">North</div>
                                                                                    <div class="tab" data-target="product2">East</div>
                                                                                    <div class="tab" data-target="product2">South</div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div class="tab" data-target="product3">VPMA Sports Day</div>
                                                    <div class="tab" data-target="product4">K Raheja Group - Pune</div>
                                                    <div class="tab" data-target="product5">Welder Meet - Kerala</div>
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-9">
                                                <div class="tab-body-wrapper">
                                                    <div class="gallery-wrapper tab-body active" id="product1">
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <div class="image-box">
                                                                    <img src="./img/shera-applications/wall-partitions.png" alt="" data-fancybox="gallery1" data-caption="Caption" />
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <div class="image-box">
                                                    ...
                                                    <div class="gallery-wrapper tab-body" id="product2">
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <div class="image-box">
                                                                    <img src="./img/shera-applications/external-cladding.jpg" alt="" data-fancybox="gallery2" data-caption="Caption" />
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <div class="image-box">
                                                    ...
                                                    <div class="gallery-wrapper tab-body" id="product3">
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <div class="image-box">
                                                                    <img src="./img/shera-applications/landscaping.jpg" alt="" data-fancybox="gallery3" data-caption="Caption" />
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <div class="image-box">
                                                    ...
                                                    <div class="gallery-wrapper tab-body" id="product4">
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <div class="image-box">
                                                                    <img src="./img/shera-applications/false-ceiling.jpg" alt="" data-fancybox="gallery4" data-caption="Caption" />
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <div class="image-box">
                                                            ...
                                                            <div class="col-lg-4 mt-5">
                                                                <div class="image-box">
                                                                    <video src="./video/intro.mp4" data-fancybox="gallery4" data-caption="Caption" poster="./img/events-gallery/demo.jpg"></video>
                                                                    <!-- <img src="./img/shera-applications/false-ceiling.jpg" alt="" data-fancybox="gallery4" data-caption="Caption" /> -->
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4 mt-5">
                                                    ...
                                                    <div class="gallery-wrapper tab-body" id="product5">
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <div class="image-box">
                                                                    <img src="./img/shera-applications/wall-cladding.jpg" alt="" data-fancybox="gallery5" data-caption="Caption" />
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <div class="image-box">
