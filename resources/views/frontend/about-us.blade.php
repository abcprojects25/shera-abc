                    ...
                    <div data-elementor-type="wp-page" data-elementor-id="34" class="elementor elementor-34">
                        <div class="inner-page about-page">
                            <section class="banner">
                                <div class="image-box">
                                    <img src="./img/about-us/banner/about-banner.webp" alt="" />
                                </div>
                                    ...
                                    >
                                        ...
                                        >
                                            <div class="elementor-widget-container">
                                                ...
                                                <h2 class="sub-heading alt"><span class="mini-heading">About Us</span> <span class="heading">Shera Company Profile</span></h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <section class="section company-section">
                                <div class="container">
                                    <div class="text-logo mb-7">
                                        <div class="heading-box">
                                            <h2 class="inner-text wcf--title alt">
                                                <span class="mini-title">01 Who we are</span> Beyond innovation, <br />
