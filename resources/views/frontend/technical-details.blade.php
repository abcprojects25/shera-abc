                                    ...
                                    >
                                        ...
                                        >
                                            <div class="elementor-widget-container">
                                                ...
                                                <h2 class="sub-heading alt"><span class="mini-heading">Technical Guide</span> <span class="heading"> The data that drives our products</span></h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </section>
                            <section class="section catalogues-section background-section">
                                <div class="container">
                                    <div class="heading-box">
                                        <div
                                            class="elementor-element elementor-element-946b02c e-con-full e-flex e-con e-child"
                                        ...
                                        >
                                            ...
                                            >
                                                <div class="elementor-widget-container">
                                                    <h4 class="wcf--title">Product Specs & Technical Info</h4>
                                                    <h2 class="wcf--title alt">Technical Guide</h2>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-3 mt-4">
                                            <div class="catalogues-wrapper">
                                                <div class="catalogues-card">
                                                    <div class="image-action">
                                                        <div class="image-box">
                                                            <img src="./img/document-thumbnails/guides/shera-board-application.jpg" alt="" />
                                                        </div>
                                                    ...
                                                    <div class="title-box mt-3">
                                                        <h5 class="shera-mini-heading">
                                                            <span class="shera-green">SHERA</span>
                                                            <span class="shera-blue">Boards</span>
                                                            Application
                                                        </h5>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-3 mt-4">
                                            <div class="catalogues-wrapper">
                                                <div class="catalogues-card">
                                                    <div class="image-action">
                                                        <div class="image-box">
                                                            <img src="./img/document-thumbnails/guides/shera-deco-board-application.jpg" alt="" />
                                                        </div>
                                                        <div class="action-button">
                                                    ...
                                                    <div class="title-box mt-3">
                                                        <h5 class="shera-mini-heading">
                                                            <span class="shera-green">SHERA</span>
                                                            <span class="shera-brown">Deco Boards</span>
                                                            Application
                                                        </h5>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-3 mt-4">
                                            <div class="catalogues-wrapper">
                                                <div class="catalogues-card">
                                                    <div class="image-action">
                                                        <div class="image-box">
                                                            <img src="./img/document-thumbnails/guides/shera-uncoloured-plank-application.jpg" alt="" />
                                                        </div>
                                                        <div class="action-button">
                                                    ...
                                                    <div class="title-box mt-3">
                                                        <h5 class="shera-mini-heading">
                                                            <span class="shera-green">SHERA</span>
                                                            <span class="shera-brown">Uncoloured Plank</span>
                                                            Application
                                                        </h5>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-3 mt-4">
                                            <div class="catalogues-wrapper">
                                                <div class="catalogues-card">
                                                    <div class="image-action">
                                                        <div class="image-box">
                                                            <img src="./img/document-thumbnails/guides/shera-pre-coloured-application.jpg" alt="" />
                                                        </div>
                                                        <div class="action-button">
                                                            <a
                                                                class="button download-button"
                                                                href="./pdf/guides/SHERA_PreColored_Plank_Application.pdf.pdf#toolbar=0&navpanes=0&scrollbar=0"
                                                                data-fancybox
                                                            >
                                                                View
                                                            </a>
                                                            <a href="#" class="button download-button" data-bs-toggle="modal" data-bs-target="#viewDownloadModal" data-pdf="SHERA_PreColored_Plank_Application.pdf" data-source="technical-details"> Download </a>
                                                        </div>
                                                    </div>
                                                    <div class="title-box mt-3">
                                                        <h5 class="shera-mini-heading">
                                                            <span class="shera-green">SHERA</span>
                                                            <span class="shera-brown">Pre Coloured Plank</span>
                                                            Application
                                                        </h5>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-3 mt-4">
                                            <div class="catalogues-wrapper">
                                                <div class="catalogues-card">
                                                    <div class="image-action">
                                                        <div class="image-box">
                                                            <img src="./img/document-thumbnails/guides/shera-splendid-plank-application.jpg" alt="" />
                                                        </div>
                                                        <div class="action-button">
                                                            ...
                                                            <a href="#" class="button download-button" data-bs-toggle="modal" data-bs-target="#viewDownloadModal" data-pdf="SHERA_Splendid_Plank_Application.pdf" data-source="technical-details"> Download </a>
                                                        </div>
                                                    </div>
                                                    <div class="title-box mt-3">
                                                        <h5 class="shera-mini-heading">
                                                            <span class="shera-green">SHERA</span>
                                                            <span class="shera-brown">Splendid Plank</span>
                                                            Application
                                                        </h5>
                                                    </div>
                                                </div>
