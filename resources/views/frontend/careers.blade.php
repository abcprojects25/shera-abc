...
<html class="no-js" lang="en">
  ...
  @include('frontend.layout.header')
                    ...
                    >
                      <div class="elementor-widget-container">
                        ...
                        <h2 class="sub-heading alt">
                          <span class="mini-heading">Careers</span>
                          <span class="heading"
                      ...
                      <!-- CAREER CONTACT MINI FORM -->
                      <div class="container">
                        <div class="career_contact_mini_form">
                          <form action="">
                            <div class="row">
                            ...
                            <div
                              class="elementor-element elementor-element-845e997 elementor-widget elementor-widget-wcf--arolax-button btn_container_wrapper"
                              data-id="845e997"
                              data-element_type="widget"
            ...
            <div class="career_main">
              <div class="career_top_sec career_heading">
                <p class="contact_main_text">
                  Where <span>Ambition</span> Meets
                </p>
                <div class="contact_secondary_p">
                  <p>
                    <span>Opportunity</span>
                  </p>
                  <div class="career_para">
                    <p>
                      At SHERA, we believe a great career is more than just a
                      job. Its a journey of continuous evolution. Our work
                      culture is deeply rooted in innovation, where every idea
          ...
          <div
            data-elementor-type="wp-page"
            data-elementor-id="34"
            class="elementor elementor-34 container"
          >
            <div class="row">
              <div class="col-lg-12 text-center dealer_nav_tabs">
                <ul class="nav nav-tabs border-0 justify-content-center">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" href="#Internal"
                      >Company Celebration</a
                    >
                  </li>
                </ul>
              </div>
              <div class="col-lg-12">
                <div class="tab-content w-100">
                  <div class="tab-pane fade show active" id="Environment">
                    <div class="inner-page shera-project-page">
                      <section class="section10 projects-gallery-section">
                        <div class="container">
