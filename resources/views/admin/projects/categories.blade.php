		...
		<div class="container-fluid">
			<div class="inner-body">
				...
				<div class="page-header">
					<div>
						<h2 class="main-content-title tx-24 mg-b-5"> Project Categories </h2>
						<ol class="breadcrumb">
						...
						<div class="card custom-card overflow-hidden">
							...
							<div class="card-body pt-0">
								...
								<div class="table-responsive">
									<table class="table table-bordered mg-b-0" id="categorytable">
										<tr> 
										...
										<tr> 
											...
											@if($item->status == 0)
												<td class="text-center"><a href="project-categories-status/{{base64_encode($item->status)}}/{{base64_encode($item->id)}}" class="btn btn-danger status_inactive" title="Change Status"><i class='fa fa-times'></i></a> </td>
											@else 
												<td class="text-center"><a href="project-categories-status/{{base64_encode($item->status)}}/{{base64_encode($item->id)}}" class="btn btn-primary status-active" title="Change Status"><i class='fa fa-check'></i></a> </td>
											@endif			
											<td class="actions">
												<a href="#" class="btn ripple btn-info"  onclick="editDetails('{{$item->id}}','{{$item->name}}','{{$item->status}}','{{$item->description}}')" data-toggle="modal" data-target="#subcategorieseditmodal"> Edit  </a> 
												<a onclick="return confirm('Are you sure?')" href="project-categories-delete/{{base64_encode($item->id)}}" class="btn ripple btn-danger"> <i class="fa fa-trash" aria-hidden="true"></i> </a>
											</td>
										</tr>
										@endforeach
									</table>
...
<div class="modal fade" id="subcategorieseditmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-md modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel"> Edi Category </h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<form method="POST" class="row justify-content-md-center" action="/admin/project/category-edit" enctype="multipart/form-data" >	
					<div class="col-xl-12 col-lg-12 col-md-12">
					@csrf			
						<div class="card shade">
							...
							<div class="form-group">
								...
								<input name="type" value="2" type="hidden"/>
								<input name="edit_category_name" value=""  class="form-control" placeholder="Subcategory type and enter..." maxlength="255" type="text" id="edit_category_name">
							</div>
							<div class="form-group">
								<label> Category Description :</label>
...
<div class="modal fade" id="subcategoriesaddmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-md modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="POST" class="row justify-content-md-center" action="/admin/project/subcategory-add" enctype="multipart/form-data" >	
					<div class="col-xl-12 col-lg-12 col-md-12">
					@csrf									
						<div class="card shade">
							<div class="form-group area_interest">
...
<script>
	...
	function editDetails(id,name,status,description){
	...
	$(document).ready(function () {
		...
		$('#reload').click(function (e) {
			...
			$.ajax({
				type: "POST",
				dataType: "json",
				url: "/admin/project/project-category-sort",
					data: {
