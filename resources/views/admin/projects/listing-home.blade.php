		...
		<div class="container-fluid">
			<div class="inner-body">
				...
				<div class="page-header">
					<div>
						<h2 class="main-content-title tx-24 mg-b-5"> All Home Projects </h2>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="#">Projects</a></li>
							<li class="breadcrumb-item active" aria-current="page">Home Project Listing</li>
						</ol>
					</div>
					<div class="d-flex">
						<div class="justify-content-center">
							<a href="/admin/project/all-project" class="btn btn-white btn-icon-text my-2 mr-2"> <i class="fe fe-folder-plus mr-2"></i> Project Listing </a> 
										...
										<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered mg-b-0" id="data-table">
											...
											<tbody>
												...
												<tr> 
													...
													@if($item->is_home == 0) 
													<td><a  href="project-home-status/{{base64_encode($item->is_home)}}/{{base64_encode($item->id)}}" class="btn btn-danger status_inactive" title="Change Status"><i class='fa fa-times'></i></a> </td>
													@else 
													<td> <a  href="project-home-status/{{base64_encode($item->is_home)}}/{{base64_encode($item->id)}}" class="btn btn-primary status-active" title="Change Status"><i class='fa fa-check'></i></a> </td>
													@endif  
													<td class="actions">
