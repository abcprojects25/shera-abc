		...
		<div class="container-fluid">
			<div class="inner-body">
				...
				<div class="page-header">
					<div>
						<h2 class="main-content-title tx-24 mg-b-5"> Add Video </h2>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="#">Home</a></li>
							<li class="breadcrumb-item"><a href="#">Video Pages</a></li>
					...
					<div class="col-sm-12">
						<div class="card custom-card overflow-hidden">
							...
							<div class="card-body pt-0">
								<div class="">
									<form method="POST" class="row justify-content-md-center" action="/admin/about/video-gallery-store" enctype="multipart/form-data" >	
										<div class="col-xl-9 col-lg-9 col-md-9">
										@csrf				 
										<div class="row">
											<div class="col-lg-12 col-md-9 form-group">
												<label> Project Name : <span>*</span></label>
												<input name="project_name" value="" required="" class="form-control" placeholder="Project Name.." maxlength="255" type="text">
											</div>
											<div class="col-lg-12 col-md-9 form-group">
												<label> Project BY : <span>*</span></label>
												<input name="project_by" value="" required="" class="form-control" placeholder="Project By.." maxlength="255" type="text">
											</div>
											<div class="col-lg-12 col-md-9 form-group">
												<label> Vimeo Url :</label>
												<input name="vurl" value="" onkeyup="urlfilter(this.value)" class="form-control" placeholder="Vimeo Url.." type="text">
												<input name="vthumb" value="" id="vthumb" type="hidden">
											</div>
										</div> 
										...
										{{-- <div class="col-xl-3 col-lg-3 col-md-3">
											...
											<div class="form-group text-center">
												<div class="image-upload"> <br>
													<label for="description">Add Videos</label>
