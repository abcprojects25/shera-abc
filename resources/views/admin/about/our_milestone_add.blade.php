		...
		<div class="container-fluid">
			<div class="inner-body">
				...
				<div class="page-header">
					<div>
						<h2 class="main-content-title tx-24 mg-b-5"> Add MileStone </h2>
						<ol class="breadcrumb">
					...
					<div class="col-sm-12">
						<div class="card custom-card overflow-hidden">
							...
							<div class="card-body pt-0">
								<div class="">
									<form method="POST" class="row justify-content-md-center" action="/admin/about/our-milestone-store" enctype="multipart/form-data" autocomplete="off">	
										<div class="col-xl-12 col-lg-9 col-md-9">
										@csrf				 
										<div class="row">
											<div class="col-lg-6 col-md-9 form-group">
												<label> Title : <span>*</span></label>
												<input name="title" value="Excellence" required="" class="form-control" placeholder="Title.." maxlength="255" type="text">
											</div>
											<div class="col-lg-6 col-md-9 form-group">
												<label> Sub-Title : <span>*</span></label>
												<input name="sub_title" value="20+ Years of Excellence" required="" class="form-control" placeholder="Sub-Title.." maxlength="255" type="text">
											</div>
											<div class="col-lg-6 col-md-9 form-group">
												<label> Timeline Year: <span>*</span></label>
												<input name="timeline_year" value="" required="" class="form-control" placeholder="Timeline Year.." maxlength="255" type="text">
											</div>

											<div class="col-lg-6 col-md-9 form-group">
												<label> Timeline Title: <span>*</span></label>
												<input name="timeline_title" value="" required="" class="form-control" placeholder="Timeline Title.." maxlength="255" type="text">
											</div>
											<div class="col-lg-6 col-md-9 form-group">
												<label> Timeline Text: <span>*</span></label>
												<input name="timeline_text" value="" required="" class="form-control" placeholder="Timeline Text.." maxlength="255" type="text">
											</div>	
											<div class="col-lg-6 col-md-9 form-group">
