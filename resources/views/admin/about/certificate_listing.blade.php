		...
		<div class="container-fluid">
			<div class="inner-body">
				...
				<div class="page-header">
					<div>
						<h2 class="main-content-title tx-24 mg-b-5"> Certificates </h2>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="#">Home</a></li>
							<li class="breadcrumb-item active" aria-current="page">Certificates Pages</li>
						</ol>
					</div>
					<div class="d-flex">
						<div class="justify-content-center">
							<a href="/admin/about/certificate-add" class="btn btn-white btn-icon-text my-2 mr-2"><i class="fe fe-folder-plus mr-2"></i> Add New Certificate </a>
						</div>
					</div>
				</div>
				<!-- End Page Header -->
							...
							<div class="card-body pt-0">
								...
								<div class="table-responsive">
									<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered mg-b-0" id="data-table">
										...
										<tbody>
											@foreach ($Certificates as $k=>$item)
											<tr class="tableRow" data-id="{{ $item->id }}">
												...
												<td> {{$item->title}} </td>
												<!-- <td>
													<a data-fancybox="gallery" href="/{{$item->thumnail}}" data-caption="">
														<img src="{{$item->thumnail}}" width="50px" class="img-fluid border" />
													</a>
												</td> -->
												<td>
													<a href="/admin/about/download-certificate-pdf/{{$item->pdf}}" target="_blank">
														<img src="/admin/img/PDF_icon.png" width="50px" class="img-fluid" />
													</a>
													{{-- <a href="javascript:void(0)" onclick="CertificatePdf('{{$item->pdf}}')"><img src="/admin/img/PDF_icon.png" width="50px" class="img-fluid" /> </a> --}}
												</td>  
												
												<td class="text-center">
													@if($item->status == 0) 
													<a  href="/admin/about/status/{{base64_encode($item->status)}}/{{base64_encode($item->id)}}" class="btn btn-danger status_inactive" title="Change Status"><i class='fa fa-times'></i></a> </td>
													@else 
													<a  href="/admin/about/status/{{base64_encode($item->status)}}/{{base64_encode($item->id)}}" class="btn btn-primary status-active" title="Change Status"><i class='fa fa-check'></i></a> </td>
													@endif
												</td>						
												<td class="actions">
													<div class="btn-group">
														<a href="/admin/about/certificate-edit/{{base64_encode($item->id)}}" class="btn ripple btn-info"> Edit  </a>
														<div class="dropdown">
															...
															<div class="dropdown-menu" aria-labelledby="dropdownMenu2">  
																<a href="/admin/about/certificate-delete/{{base64_encode($item->id)}}" onclick="return confirm('Are you sure?')"> Delete </a> 
															</div>
														</div>
													</div> 
												</td>
...
<!-- PDF Viewer -->
<div class="modal fade" id="PdfPopupModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header" style="padding:2px 10px;border:none;background:none;">
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body text-center">
				<iframe id="certificatepdf" allow="autoplay; encrypted-media" scrollig="0" src="/viewerjs/?title=&amp;#../pdf/catalogue/alzinc_vol2_new_ecatalogue.jpg" allowfullscreen="" style="width:100% !important;height:600px; !important;" frameborder="0"></iframe>
			</div>
		</div>
	</div>
</div>
