		...
		<div class="container-fluid">
			<div class="inner-body">
				...
				<div class="page-header">
					<div>
						<h2 class="main-content-title tx-24 mg-b-5"> Edit Testimonials </h2>
						<ol class="breadcrumb">
					...
					<div class="col-sm-12">
						<div class="card custom-card overflow-hidden">
							...
							<div class="card-body pt-0">
								<div class="">
									<form method="POST" class="row justify-content-md-center" action="/admin/about/testimonial-update" enctype="multipart/form-data" >	
										...
										<div class="row">
											<div class="col-lg-12 col-md-9 form-group">
												...
												<input name="name" value="{{$EditData->name}}" required="" class="form-control" placeholder="Name.." maxlength="255" type="text">
											</div>
											<div class="col-lg-6 col-md-9 form-group">
												<label> Designation :</label>
												<input name="occupation" value="{{$EditData->occupation}}" class="form-control" placeholder="Designation.." maxlength="255" type="text">
											</div>
											<div class="col-lg-6 col-md-9 form-group">
												<label> Type </label>
												<select name="type" id="type" class="custom-select w-100">
													<option selected disabled>-- Select Type --</option>
													<option value="1" {{ $EditData->type == 1 ? 'selected' : '' }}>Text</option>
													<option value="2" {{ $EditData->type == 2 ? 'selected' : '' }}>Video</option> 
												</select>
											</div>
											<div class="col-lg-6 col-md-9 form-group">
												<label> Video URL :</label>
												<input name="video_url" id="video_url" value="{{$EditData->video_url}}"  onkeyup="youtube_parser(this.value)" class="form-control" placeholder="Video URL.." maxlength="255" type="text">
												<input name="video_thumb" value="{{$EditData->video_thumb}}" id="video_thumb" type="hidden">
											
											</div> 
											<div class="col-lg-6 col-md-9 form-group">
												<label> Company Name :</label>
												<input name="designation_company" value="{{$EditData->designation_company}}" class="form-control" placeholder="Company Name.." maxlength="255" type="text">
											</div>
											<div class="col-lg-12 form-group">
												<label> Description :</label>
												<textarea name="description" class="form-control" placeholder="Description.." maxlength="255" type="text" rows="4" cols="50"> {{$EditData->description}}</textarea> 
											</div> 
										</div>
										...
										<div class="col-xl-3 col-lg-3 col-md-3">
											...
											<div class="form-group text-center">
												<div class="image-upload"> <br>
													...
													<center>
														<label for="upload"> 
														<img src="{{($EditData->thumnail) ? $EditData->thumnail : '/admin/img/choose_file.jpg'}} " id='imgid' class="text-center img-fluid" style="cursor: pointer" title="Click here to update Image" /> </label>
													</center>
