											...
											<form method="POST" class="row justify-content-md-center" action="/admin/about/certificate-store" enctype="multipart/form-data" >	
												...
												<div class="row">
													<div class="col-lg-6 col-md-6 form-group">
														<label>Certificate/Test Title : <span>*</span></label>
														<input name="certificate_title" value="" required="" class="form-control" placeholder="Certificate/Test Title" maxlength="255" type="text">
													</div>
													<div class="col-lg-6 col-md-6 form-group">
														<label> Choose Categories </label>
														<select name="type" class="custom-select w-100">
															<option selected disabled>-- Select Categories --</option>
															<option value="automotive">Automotive research association of india</option>
															<option value="indianinstitute">Indian Institute of Technology Bombay</option> 
															<option value="iso">ISO</option>													
															<option value="thomasbell">Thomas Bell Wrigth International Consultants</option> 
															<option value="technicaldata">Technical Data Sheet</option>													
														</select>
													</div>
													...
													<div class="col-lg-6 col-md-9 form-group">
														...
														<input name="certificate_pdf" value="" required="" class="form-control btn @error('certificate_pdf') is-invalid @enderror" type="file">
