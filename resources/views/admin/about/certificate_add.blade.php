		...
		<div class="container-fluid">
			<div class="inner-body">
				...
				<div class="page-header">
					<div>
						<h2 class="main-content-title tx-24 mg-b-5"> Add Certificates </h2>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="#">Home</a></li>
							<li class="breadcrumb-item"><a href="#">Certificates Pages</a></li>
							<li class="breadcrumb-item active" aria-current="page">Add Certificates</li>
						</ol>
					</div>
					...
					<div class="col-sm-12">
						<div class="card custom-card overflow-hidden">
							...
							<div class="card-body pt-0">
								<div class="">
									<form method="POST" class="row justify-content-md-center" action="/admin/about/certificate-store" enctype="multipart/form-data" >	
										<div class="col-xl-9 col-lg-9 col-md-9">
										@csrf				 
										<div class="row">
											<div class="col-lg-12 col-md-9 form-group">
												<label>Certificate Title : <span>*</span></label>
												<input name="certificate_title" value="" required="" class="form-control" placeholder="certificate Title" maxlength="255" type="text">
											</div>
											...
											<div class="col-lg-6 col-md-9 form-group">
												...
												<select name="certificate_assigned_by" class="custom-select w-100">
													...
													<option value="automotive_research">Automotive research association of india</option>
													<option value="indian_institute">Indian Institute of Technology Bombay</option>													
													<option value="iso">ISO</option>													
													<option value="thomas_bell">Thomas Bell Wrigth International Consultants</option>			
											...
											<div class="col-lg-6 col-md-9 form-group">
												<label>PDF Select : <span>*</span></label>
												<input name="certificate_pdf" value="" required="" class="form-control @error('certificate_pdf') is-invalid @enderror" type="file">
										...
										<div class="col-xl-3 col-lg-3 col-md-3">
											...
											<div class="form-group text-center">
												<div class="image-upload"> <br>
													<label for="description">Add Certificate Thumbnail</label>
													<input type="hidden" name="thumnail" class="hidden-image-data" required/>
													<center>
														<label for="upload"> 
														<img src="http://dev.vivaacp.com/admin/img/choose_file.jpg" id='imgid' class="text-center img-fluid" style="cursor: pointer" title="Click here to update Image" /> </label>
													</center>
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Add Certificate Thumbnail </h4>
