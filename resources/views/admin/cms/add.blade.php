					...
					<div class="col-sm-12">
						<div class="card custom-card overflow-hidden">
							...
							<div class="card-body pt-0">
								<div class="">
									<form method="POST" class="row justify-content-md-center" action="/admin/cms/cms-store" 
											...
											<div class="card shade">
												<div class="row">
													<div class="col-lg-6 col-md-6 form-group">
														...
														<input name="name" value="" required="" class="form-control" placeholder="Page Name..." maxlength="255" type="text" id="name" onkeypress="ArticleNameurl();"   onblur="ArticleNameurl();">
													</div>
													<div class="col-lg-6 col-md-6 form-group"> 
												...
												<div class="form-group">
													...
													<textarea name="description" class="form-control content" cols="10" rows="2" id="TinyEditor"> </textarea>
												</div>
