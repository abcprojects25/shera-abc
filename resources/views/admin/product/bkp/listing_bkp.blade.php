								...
								<div class="table-responsive">
									<table class="table table-bordered mg-b-0">
										...
										<tr> 
											...
											<td> 11 Oct 2023<br> <small class="text-muted">09:32:AM</small> </td> 
											@if (!empty($item->image))
											...
											<td class="actions">
												...
												<a href="/admin/product/product-view" class="btn ripple btn-warning"> View </a> 
												...
												<a href="#" data-toggle="modal" data-target="#ServerImageModal" class="btn ripple btn-primary"> Add Images </a> 
											</td>
										</tr> 
										@endforeach
									</table>
