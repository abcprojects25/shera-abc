		...
		<div class="container-fluid">
			<div class="inner-body">
				...
				<div class="page-header">
					<div>
						<h2 class="main-content-title tx-24 mg-b-5"> All Home Products </h2>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="#">Products</a></li>
							<li class="breadcrumb-item active" aria-current="page">Home Product Listing</li>
						</ol>
					</div>
					<div class="d-flex">
						<div class="justify-content-center">
							<a href="/admin/product/all-product" class="btn btn-white btn-icon-text my-2 mr-2"> <i class="fe fe-folder-plus mr-2"></i> Product Listing </a> 
								...
								<div class="table-responsive">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered mg-b-0" id="data-table">
											...
											<tr>
												...
												<th class="text-center" style="width:60px"> Home Status </th>
												<th> Actions </th>
											</tr>
											</thead>
											<tbody>
												...
												<tr> 
													...
													@if($item->status == 0) 
													<td><a  href="product-status/{{base64_encode($item->status)}}/{{base64_encode($item->id)}}" class="btn btn-danger status_inactive" title="Change Status"><i class='fa fa-times'></i></a> </td>
													@else 
													<td> <a  href="product-status/{{base64_encode($item->status)}}/{{base64_encode($item->id)}}" class="btn btn-primary status-active" title="Change Status"><i class='fa fa-check'></i></a> </td>
													@endif
													...
													<td class="actions">
														...
														<a href="/product/product-view" class="btn ripple btn-warning" target="_blank"> View </a> 
														<a onclick="return confirm('Are you sure?')" href="/admin/product/delete-product/{{base64_encode($item->id)}}" class="btn ripple btn-danger"> <i class="fa fa-trash" aria-hidden="true"></i>  </a>
