					...
					<div class="col-sm-12">
						<div class="card custom-card overflow-hidden">
							<div class="card-header border-bottom-0">
								<div class="row">			
									<div class="col-sm-6"> <label class="main-content-label mb-2"> Contact Listing </label> </div>
									<div class="col-sm-6">
								...
								<div class="table-responsive">
									<table class="table table-bordered mg-b-0">
										...
										<tr> 
											...
											<td class="actions">
												<a onclick="return confirm('Are you sure?')" href="/admin/contact-us-delete/{{base64_encode($value->id)}}" class="btn ripple btn-danger"> <i class="fa fa-trash" aria-hidden="true"></i> </a>
											</td>
										</tr>
										@endforeach
									</table>
