											...
											<div class="card-item">
												...
												<div class="card-item-body">
													<div class="card-item-stat">
														...
														<small><b class="text-success"><a href="inquiry"> Include All </a></b> </small>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="card custom-card">
										<div class="card-body">
											<div class="card-item">												
												...
												<div class="card-item-body">
													<div class="card-item-stat">
														<h4 class="font-weight-bold">{{$careersCount}}</h4> <small><b class="text-success"> <a href="career"> Include All </a></b></small> </div>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="card custom-card">
										<div class="card-body">
											<div class="card-item">
												...
												<div class="card-item-body">
													<div class="card-item-stat">
														<h4 class="font-weight-bold">{{$ProjectsCount}}</h4> <small><b class="text-danger"> <a href="project/all-project"> Include All </a></b></small> </div>
												</div>
											</div>
										</div>
									</div>
												...
												<table class="table card-table table-vcenter mb-0  border">
													...
													<tbody>
														...
														<tr>
															...
															<td class=" "> <a href="mailto:<?=$item->email?>"> {{$item->email}} </a> </td>
															<td>{{$item->message}}</td>
														</tr>
														@endforeach
													</tbody>
