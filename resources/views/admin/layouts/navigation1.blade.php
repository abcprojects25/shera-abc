<ul class="nav">
	...
	<li class="nav-item">
		...
		<ul class="nav-sub">
			<li class="nav-sub-item"> <a class="nav-sub-link" href="/admin/seo"> SEO Tags Lising </a> </li>  
			<!--<li class="nav-sub-item"> <a class="nav-sub-link" href="/admin/seo/url-listing"> SEO URL Lising </a> </li> -->  
		</ul>
	</li>
