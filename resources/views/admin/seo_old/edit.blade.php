											...
											<div class="card shade">
												<div class="row">
													<div class="col-lg-12 col-md-12 form-group">
														...
														<select name="url_id" class="form-control w-100" id="urls_list" onchange="getPageName(this)" required>
															...
															<option value="{{$item->id}}" data-id="{{$item->urls}}" {{ $edit_data->url_id == $item->id ? 'selected' : '' }}>{{$item->page_name}}</option>
															@endforeach
														</select>
													</div>
												</div>
												<div class="row">
													<div class="col-lg-5 col-md-5 form-group">
														...
														<input name="page_name" value="{{($edit_data->page_name) ? $edit_data->page_name : ''}}"  class="form-control" placeholder="Page Name..." type="text" id="page_name" readonly>
													</div> 
